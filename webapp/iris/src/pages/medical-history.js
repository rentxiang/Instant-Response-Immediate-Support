...
class MedicalHistory extends Component {
  constructor(props) {
    ...
    this.state = { vitals: {}, medicalHistory: [], physicians: [] };

    APIHelper.getAllPhysicians(this.props.user.state.accessToken).then((data) => {
        ...
        onSubmit={(values) => {
          ...
          APIHelper.updateCallerVitals(
            ...
            .then((data) => {
              console.log(data);
              const payload = {
                receiver: { physician: "6269332080d874163dea5562" },
              };
              /**
              ...
              APIHelper.updateRequest(this.props.request.state._id, payload, this.props.user.state.accessToken)
                ...
                .then((data) => {
                  ...
                  APIHelper.updateRequest(data._id, payload, this.props.user.state.accessToken).then((response) => {
                    ...
                    const physicianId ="6269332080d874163dea5562";// data.caller.receiver.physician;
                    APIHelper.sendMeetingLink(physicianId, meetingURL).then((data) => console.log(data));
