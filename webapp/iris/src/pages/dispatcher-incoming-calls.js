    ...
    return (
      <div className="incomingCall">
        ...
        <div className="mapContainer">
          <div className="map"><MapContainer showCallerLocation={false} data={{callerLocation: this.state.callerLocation, mapLaunchOption: MapLaunchOption.DispatcherIncomingCalls, resetMap: this.state.resetMap}} /></div>
          <div className="resetBtn"><button id="reset-btn" onClick={this.resetHandler.bind(this)}>
            Reset
          </button>
          </div>
        </div>
