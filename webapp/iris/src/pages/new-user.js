 ...
 * @returns 
 */
const mapStateToProps = (state) => ({ userObject: state.userReducer });
...
class NewUser extends Component {    
    ...
    render() {
        ...
        if (this.props.userObject.state !== undefined) {
            var isEditable = true;
        }

        return (
            <Formik
                initialValues={this.props.userObject.state !== undefined ? this.props.userObject.state : {}}
                /**
                ...
                onSubmit={(values) => {
                    ...
                    if (isEditable === true) {
                        APIHelper.updateUser(values, this.props.userObject.state.accessToken).then((data => {
                            console.log(data);
                        }));
                        this.goBack();
                    } else {
