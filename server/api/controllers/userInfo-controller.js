        ...
        .then(async user => {
            ...
            if (user) { 
                ...
                var mailOptions = {
                    ...
                    html: "<h4>Hello,</h4><p>This is a system generated email, do not reply!<br> You have been added as a dispatcher in the application. UserName is same as the email-ID you provided us, and the password is Hello@Iris. <br>You will have to change the password after the first login.</p><p>Regards,<br>Team IRIS</p>"
                };
